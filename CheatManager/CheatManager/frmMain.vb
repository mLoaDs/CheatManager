...
Public Class frmMain
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If Not IO.File.Exists(".\Cheats.db") Then
            CreateDB()
            MsgBox("No Cheats.db exists, new Cheats.db was created")
        End If
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        'added MessageBox
        If MsgBox("Really delete the game from the database?", vbYesNo) = vbYes Then
    ...
    Private Sub CboSort_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CboSort.SelectedIndexChanged
        ...
        Dim pic = CType(My.Resources.ResourceManager.GetObject(CStr(CboSort.SelectedItem)), Image)
    ...
    Private Sub dlc_Click(sender As System.Object, e As System.EventArgs) Handles dlc.Click
        frmCheatsDB.Show()
    End Sub
    ...
    Private Sub PictureBox5_Click(sender As System.Object, e As System.EventArgs) Handles PictureBox5.Click
        Process.Start("https://github.com/mLoaDs")
    End Sub
End Class