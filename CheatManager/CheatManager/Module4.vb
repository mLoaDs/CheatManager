...
Module modGGconverter
    ...
    'Utility Functions
    Public Sub testgg()
        'Test GG Functions with set values for comparasen. Used UGGConv opensource app to generate mem address, and code.
        'As this is what I converted the code from. Values match 100%
        Dim try1 As String = ""
        modGGconverter.gameGenieEncodeGameBoy("3915:C9:35", try1)
        MsgBox(try1 & "=C99-15C-3BE", , "Game Boy Encode Test")
        modGGconverter.gameGenieDecodeGameBoy("C99-15C-3BE", try1)
        MsgBox(try1 & "=3915:C9:35", , "Game Boy Decode Test")
        try1 = ""
        modGGconverter.gameGenieEncodeMegadrive("010024:6754", try1)
        MsgBox(try1 & "=LTAA-CR3E", , "Genesis Encode Test")
        modGGconverter.gameGenieDecodeMegadrive("LTAA-CR3E", try1)
        MsgBox(try1 & "=010024:6754", , "Genesis Decode Test")
        try1 = ""
        modGGconverter.gameGenieEncodeSNES("0780F7:CF", try1)
        MsgBox(try1 & "=AE6E-DF2A", , "Snes Encode Test")
        modGGconverter.gameGenieDecodeSNES("AE6E-DF2A", try1)
        MsgBox(try1 & "=0780F7:CF", , "Snes Decode Test")
        try1 = ""
        modGGconverter.gameGenieEncodeNES("E0A8:01:03", try1)
        MsgBox(try1 & "=PEZVAALA", , "nes Encode Test")
        try1 = ""
        modGGconverter.gameGenieDecodeNES("PEZVAALA", try1)
